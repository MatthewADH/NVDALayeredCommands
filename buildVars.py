...
addon_info = AddonInfo(
	...
	addon_name="layeredCommands",
	# Add-on summary/title, usually the user visible name of the add-on
	# Translators: Summary/title for this add-on
	# to be shown on installation and add-on information found in add-on store
	addon_summary=_("Layered Commands"),
	# Add-on description
	# Translators: Long description to be shown for this add-on on add-on information from add-on store
	addon_description=_("""Implements JAWS like layered commands keystrokes
Press NVDA+Alt+Space to activate layered command mode
Press slash or question mark in any layer to get a list of commands for that layer
Activation gesture can be modified in input gestures -> input"""),
	# version
	addon_version="1.0",
	...
	# Author(s)
	addon_author="Matthew Duffell-Hoffman   matthew.duffell.h@gmail.com",
	# URL for the add-on documentation support
	addon_url=None,
	# URL for the add-on repository where the source code can be found
	addon_sourceURL="https://github.com/MatthewADH/NVDALayeredCommands",
...
pythonSources: list[str] = ["addon/globalPlugins/*.py",
  "addon/globalPlugins/layers/*.py",
  "addon/globalPlugins/layers/volume/*.py"]
